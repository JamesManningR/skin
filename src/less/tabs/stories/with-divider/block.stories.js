export default { title: "Skin/Tabs/WithDivider/Block" };

export const two = () => `
<span class="tabs tabs--with-divider">
...
<span class="tabs tabs--with-divider">
    <div class="tabs__items" role="tablist">
        ...
        <div aria-controls="panel3" class="tabs__item" role="tab" aria-selected="false" id="tab3">
            <span>Tab 3</span>
        </div>
    </div>
    <div class="tabs__content">
        ...
        <div class="tabs__panel" id="panel3" role="tabpanel" hidden aria-labelledby="tab3">
            <div class="tabs__cell">
                <p>Lorem ipsum dolor sit amet.</p>
            </div>
        </div>
...
<span class="tabs tabs--with-divider">
    <div class="tabs__items" role="tablist">
        ...
        <div aria-controls="panel4" class="tabs__item" role="tab" aria-selected="false" id="tab4">
            <span>Tab 4</span>
        </div>
    </div>
    <div class="tabs__content">
        ...
        <div class="tabs__panel" id="panel4" role="tabpanel" hidden aria-labelledby="tab4">
            <div class="tabs__cell">
                <p>Lorem ipsum dolor sit amet.</p>
            </div>
        </div>
...
export const RTL = () => `
<div dir="rtl">
    <div class="tabs tabs--with-divider">
        <div class="tabs__items" role="tablist">
